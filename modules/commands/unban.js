    ...
    case 'ad':
      {
        ...
        api.sendMessage("[⚜️] Đã gỡ ban cho toàn bộ Admin Bot", threadID, messageID)
        break;
      }
    ...
    case 'ndh':
      {
        ...
        api.sendMessage("[⚜️] Đã gỡ ban cho toàn bộ Người hỗ trợ", threadID, messageID)
        break;
      }
    ...
    case 'allthread':
      {
        ...
        api.sendMessage("[⚜️] Đã gỡ ban cho toàn nhóm trên server", threadID, messageID)
        break;
      }
    ...
    case 'thread':
      {
        ...
        api.sendMessage("[⚜️] Đã gỡ ban cho nhóm này", threadID, messageID)
        break;
      }
    ...
    case 'alluser':
      {
        ...
        api.sendMessage("[⚜️] Đã gỡ ban cho toàn bộ người dùng trên server", threadID, messageID)
        break;
      }
    ...
    case 'allqtv':
      {
        ...
        api.sendMessage('[⚜️] Đã gỡ ban cho toàn bộ Quản trị viên trên server', threadID, messageID);
        break;
      }
    ...
    case 'Qtv':
      {
        ...
        api.sendMessage("[⚜️] Đã gỡ ban cho toàn bộ Quản trị viên nhóm này", threadID, messageID)
        break;
      }
    ...
    case 'user':
      {
        if (!args[1]) {
         // var threadInfo = await api.getThreadInfo(event.threadID);
          ...
          return api.sendMessage("[⚜️] Đã gỡ ban cho toàn bộ thành viên trong nhóm này", threadID, messageID);
        }
        if (args.join().indexOf('@') !== -1) {
          ...
          return api.sendMessage(`[⚜️] Người dùng ${nameUser} đã được gỡ ban`, threadID, messageID)
        }
        break;
      }
