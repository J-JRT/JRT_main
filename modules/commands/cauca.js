...
module.exports.onLoad = async function () {
    ...
    require("axios").get("https://raw.githubusercontent.com/J-JRT/version/mainV2/version.json").then(res => {
    ...
    await require("axios").get("https://raw.githubusercontent.com/J-JRT/fishing/mainV2/data.json").then(async (res) => {
...
module.exports.run = async function ({ event, api, args }) {
    ...
    switch ((args[0] || "").toLowerCase()) {
        ...
        default: {
            ...
            } catch (error) { console.log(error); return api.sendMessage("[ Fishing ] CÂU CON CẶC HẾT CÁ RỒI", threadID, messageID) }
        }
    }
}