module.exports = function({ api, models }) {
	...
	logger(`${api.getCurrentUserID()} - [ ${global.config.PREFIX} ] ⪼ ${(!global.config.BOTNAME) ? "This bot was made by CatalizCS and SpermLord" : global.config.BOTNAME}`, "[ THÔNG TIN BOT ]");
